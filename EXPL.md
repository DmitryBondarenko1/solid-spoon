...
Таким образом, на основе вышеперечисленных отзывов и анализируя функционал приложение, формируем структуру будущей документации. См. файл. Жирным в тексте отмечены разделы, непосредственно затрагивающие тему консолей.
