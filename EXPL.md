...
Таким образом, мы видим, что из заявленных в предыдущем разделе сообщений выстраивается цепочка статей, связанных общей темой консоли и появляется структура будущего документа:
