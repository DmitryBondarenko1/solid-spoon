...
| Error output | Defines the font style of error messages in the console |
| Standard output | Defines the font style of output messages in the console  |
| System output | Defines the font style of output system messages in the console |
| User input| Defines the font style of user input messages in the console |
