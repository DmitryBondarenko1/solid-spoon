...
Note: to customize a console view, your color scheme should be editable. For more information, refer to the [Selecting Color Scheme](Scheme.md) section in the [Configuring the IDE](ConfiguringIDE.md) chapter.  
...
| User input| Defines the view of user input messages |
 ...
 6. Specify your desired color settings using the menu in the the right-hand pane. For information on how to work with the menu, refer to section [Color Tool](ColorTool.md) in the [Configuring the IDE](ConfiguringIDE.md) chapter. Settings you make are instantly shown in the preview at the bottom of the menu.
