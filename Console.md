...
The console in IntelliJ IDEA is a more advanced tool than a regular console. Besides common functions like input and output you can change its appearance and behavior according to your preferences and consequently work more efficiently.
