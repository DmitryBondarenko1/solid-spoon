...
IntelliJ IDEA enables you to define a custom view of the application console and event log. Thus, you can individually configure color, font style, and highlighting rules for input, error, and output messages. 
