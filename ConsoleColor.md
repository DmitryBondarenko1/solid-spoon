...
Note: to customize console, your color scheme must be editable. For more information, refer to the [Selecting Color Scheme](Scheme.md) section in the [Configuring the IDE](ConfiguringIDE.md) chapter.  
