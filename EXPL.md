...
Выполенние задания проведем в несколько этапов:
...
Одним из важнейших условий успешности продукта является клиентоориентированных подход к его разработке. Это же в полной мере касается и пользовательской документации. Для обеспечения положительного опыта использования продукта критические важным является готовность отвечать на текущие запросы пользователей. 

**3. Формирование документации на основе use кейсов.**

**4. Подготовка контента**. Демонстрируется знание английского языка, навыки составления документации в разных стилях, знание предметной области.
